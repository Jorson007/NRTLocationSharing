...
//user2:123456
-(void)jumpToNext{
    if(([self.username.text isEqualToString:@"user1"]|| [self.username.text isEqualToString:@"user2"]) && ([self.password.text isEqualToString:@"123456"]|| [self.password.text isEqualToString:@"123456"]))
    [self.delegate changeToMainViewController];
}
