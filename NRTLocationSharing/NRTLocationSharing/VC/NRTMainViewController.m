...
-(UILabel *)userNoLabel{
    if(!_userNoLabel){
        _userNoLabel = [[UILabel alloc] initWithFrame:CGRectMake(20, 550, 80, 50)];
...
-(UITextField *)userNoTextFiled{
    if(!_userNoTextFiled){
        _userNoTextFiled = [[UITextField alloc] initWithFrame:CGRectMake(110, 550, 260, 50)];
...
-(void)startShareBtnAction{
    NSNumber *latitude =[NSNumber numberWithDouble:self.hotAnnotation.coordinate.latitude];
    NSNumber *longitude =[NSNumber numberWithDouble:self.hotAnnotation.coordinate.longitude];
